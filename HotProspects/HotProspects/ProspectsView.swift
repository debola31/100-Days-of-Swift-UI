...
//            let trigger = UNCalendarNotificationTrigger(dateMatching: dateComponents, repeats: false)
    ...
    var body: some View {
        NavigationView {
            Form {
                Section {
                    Button {
                        ...
                        Text("Sort By: \(prospects.sortStyle == .name ? "Name" : "Most Recent")")
                    }
                }
            ...
            .confirmationDialog("Sort By", isPresented: $isShowingDialog) {
                Button("Most Recent") {
                    prospects.sort(.mostRecent)
                }
                Button("Name") {
                    prospects.sort(.name)
                }
